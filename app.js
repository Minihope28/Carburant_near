...
async function searchMoroccoQuery(query) {
  const stationsList = document.getElementById("stationsList");
  const statusDot = document.getElementById("statusDot");
  const currentLocation = document.getElementById("currentLocationDisplay");
...
function renderMoroccoOverview(data) {
  ...
  if (closestEl) {
    ...
    closestEl.textContent = first && typeof first._distance === "number"
      ? `${(first._distance / 1000).toFixed(1)} km`
      : "—";
  }
}
...
function renderMoroccoStations(data) {
  ...
  stationsList.innerHTML = stationsArr
    .slice(0, 20)
    .map((s, index) => {
          ...
          <div class="card-body">
            <div class="card-main">
              ...
              <div class="card-meta">
                ...
                <span class="card-meta-item">
                  <i class="fa-solid fa-gas-pump"></i>
                  Essence ${escapeHtml(s.gasoline || "—")}
                </span>
                <span class="card-meta-item">
                  <i class="fa-solid fa-oil-can"></i>
                  Diesel ${escapeHtml(s.diesel || "—")}
                </span>
              </div>
            </div>
